...
/*
    ...
    iniciar(){
        ...
        this.obj.setAttribute('id',this.nombre);
        this.obj.innerText="*";
        this.obj.style.position = "absolute";
        this.obj.style.fontSize = this.size+"px";
        ...
        iniNevada(num, vel)
        {
            ...
            var losCopos = this.iniCopos(this.num, ancho, alto)
            this.nevar(losCopos, ancho,alto, vel);
        }

        nevar(copos, coposAncho, coposAlto, vel){
                    var x, y;
            for (let i = 0; i < this.copos.length; i++){
...
let ejecutar = new oCopo(400, 200);
